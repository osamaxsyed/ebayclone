...
<body>
<h2 align="left"><font><strong>Showing Items Categorized by Type </strong></font></h2>
...
try {
	...
	ResultSet myRs = myStmt.executeQuery("select * from cs336db.has h,cs336db.item i,cs336db.Auction a where h.item_ID = i.item_ID AND h.auction_id = a.auction_id AND i.item_type = '"+ Item_Type +"';");
